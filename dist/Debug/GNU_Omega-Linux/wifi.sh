...
Marketplace
Explore
 @raphaelthurnherr Sign out
10
4 2 OnionIoT/wifisetup
 Code  Issues 1  Pull requests 0  Projects 0  Wiki  Insights
wifisetup/wifisetup.sh
7913a88  on 1 Oct 2015
@greenbreakfast greenbreakfast added ability to set ip address of omega in AP mode
    
Executable File  964 lines (804 sloc)  18.1 KB
#!/bin/sh
